...
#
# Created: Sat Jun 08 18:34:32 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dock_spectrum.setGeometry(QtCore.QRect(0, 300, 325, 256))
        ...
        self.dock_measure = QtGui.QDockWidget(MainWindow)
        self.dock_measure.setMinimumSize(QtCore.QSize(325, 265))
        self.dock_measure.setFeatures(QtGui.QDockWidget.AllDockWidgetFeatures)
        self.dock_measure.setObjectName(_fromUtf8("dock_measure"))
        self.dockWidgetContents_3 = QtGui.QWidget()
        self.dockWidgetContents_3.setObjectName(_fromUtf8("dockWidgetContents_3"))
        self.plot_meas = Qwt5.QwtPlot(self.dockWidgetContents_3)
        self.plot_meas.setGeometry(QtCore.QRect(10, 10, 291, 201))
        self.plot_meas.setStyleSheet(_fromUtf8("font: 8pt \"MS Shell Dlg 2\";"))
        self.plot_meas.setObjectName(_fromUtf8("plot_meas"))
        self.dock_measure.setWidget(self.dockWidgetContents_3)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.dock_measure)
        ...
        self.action_record = QtGui.QAction(MainWindow)
        self.action_record.setCheckable(True)
        self.action_record.setEnabled(True)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/record.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.toolbar_main.addAction(self.action_record)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dock_measure.setWindowTitle(_translate("MainWindow", "Measured Values", None))
        ...
        self.action_wiki.setText(_translate("MainWindow", "Tow Tank Wiki", None))
        ...
        self.action_record.setText(_translate("MainWindow", "Record", None))
        self.action_record.setToolTip(_translate("MainWindow", "Enable Data Recording", None))
